...
parser.add_argument('--data_dir', type=str, default='/home/moucheng/projects_data/HCP/103818_1', help='data set')
parser.add_argument('--name', type=str,  default='mlp', help='model name')
parser.add_argument('--nparams', type=int,  default=5, help='number of parameters')
parser.add_argument('--epochs_no', type=int,  default=2, help='maximum epoch number to train')
...
parser.add_argument('--debug', type=str,  default='1', help='debug or ot')
...
if __name__ == "__main__":
    ...
    if args.name == 'mlp':
        net = Net(gradient_directions_no0, b_values_no0, args.nparams)
    else:
    ...
    plt0 = ax[5].imshow(mu_cart_map[:, :, zslice, :])
    plt.colorbar(plt0, ax=ax[5])
    ax[5].set_title('Color stick volume fraction')
    ax[5].axis('off')
