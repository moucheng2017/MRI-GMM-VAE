...
class Net_GMM_V2(nn.Module):
    '''
    Implementation of Variational Auto Encoder with Gaussian Mixture Priors and we multiply the weights
    '''
    def __init__(self,
        ...
        Args:
            ...
            samples:
            prior_std:
            type: for controlling how to inject Cat prior into the models
            mri_model:
        '''

        super(Net_GMM_V2, self).__init__()
